    ...
    public partial class reporteDepartamentos : System.Web.UI.Page
    {
        ...
        protected void cargaFrecuencias()
        {
            ...
            using (SqlConnection conexionDB = new SqlConnection(ConfigurationManager.ConnectionStrings["MyConnection"].ConnectionString))
            {
                ...
                SqlCommand cmd = new SqlCommand("estadisticasDepartamentos", conexionDB);
                ...
                ChartTotal.Series[0].XValueMember = "departamento";
                ...
                ChartTotalMes.Series[0].XValueMember = "departamento";
